...
public interface OrdenRepository extends JpaRepository<Orden, Integer> {
    ...
    @org.springframework.data.jpa.repository.Query("SELECT o FROM Orden o JOIN o.detalles d WHERE o.usuario.email = :email AND d.producto.id = :productoId AND o.estado = 'PENDIENTE_PAGO'")
